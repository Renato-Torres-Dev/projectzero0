...
export const ProjectMouraBRCard = () => {
  return (
    <div className="rounded-lg h-[436px] flex flex-col bg-gray-800 overflow:hidden border-2 border-gray-800 hover:border-red-500 opacity-70 hover:opacity-100 transition-all group">
      ...
      <div className="flex-1 flex flex-col p-8">
        <strong className="font-medium text-gray-50/90 group-hover:text-red-500 transition-all">Baterias Moura</strong>
        <p className="mt-2 text-gray-400 line-clamp-4">Projeto da Baterias Moura, onde realizo todo trabalho de Front-End juntamente com uma equipe, sempre pensando na melhor performance para o cliente.</p>
